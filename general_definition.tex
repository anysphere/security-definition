...
First, we describe how the server and clients interact when the server behaves honestly. We call this scenario the Honest Server Experiment. To enforce robustness, an adversary controls a subset of users and passively monitors all conversations.
